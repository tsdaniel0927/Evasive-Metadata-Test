...
def train_and_test(model, task):
    ...
    config['save_path'] = 'checkpoint/weights.best.' + task + "_increased" + "." + model_suffix
    ...
    # nn.load_state_dict(torch.load('checkpoint/weights.best.twitter16_increased.glan',map_location=torch.device('cpu')))
