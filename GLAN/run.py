...
if __name__ == '__main__':
    ...
    # task = 'twitter16'
    # task = 'weibo'
    task = 'twitter_replies_all'
    # task = 'twitter_replies_no'
    # task = 'twitter_time_240'
    # task = 'twitter_time_480'
    # task = 'twitter_time_720'
    # task = 'twitter_replies_swapped'
    # task = 'twitter_random_td'
    print("task: ", task)
