...
def main():
    ...
    x_test_random, y_test_random = load_path_data_pheme_with_test_gen(
        test_path, label_path, '220913__new_data/gen_test_dict_random.json',
    )

    x_test_response, y_test_response = load_path_data_pheme_with_test_gen(
        test_path, label_path, '220913__new_data/gen_test_dict_response.json',
    )
