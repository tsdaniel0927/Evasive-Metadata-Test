...
def main():
    ...
    test_path = join('220913__new_data', 'gen_test1516_rand_time.json')
    ...
    # path_random_id2paths_dict_path = join('220913__new_data', 'id2paths%s_dict.json' % _args.dataset)
    # path_random_npz = join('220913__new_data', 'all.npz')
    # response_id2paths_dict_path = join('220913__new_data', 'id2paths%s_dict.json' % _args.dataset)
    # response_wae_npz = join('220913__new_data', 'all.npz')

    x_test_random, y_test_random = load_path_data_with_1516_test(
        test_path, label_path, path_random_id2paths_dict_path, path_random_npz)

    x_test_response, y_test_response = load_path_data_with_1516_test(
        test_path, label_path, response_id2paths_dict_path, response_wae_npz)
